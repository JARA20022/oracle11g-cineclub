...
│ ├── Entrega_Oracle11g_RodrigoJara.docx # Documento Word con instalación, pasos y capturas (Entrega 1)
│ ├── Entrega2_Capturas.docx # Documento Word con evidencias de la entrega 2
│ └── Entrega3_Capturas.docx # Documento Word con evidencias de la entrega 3
│
├── sql/
...
│ └── 04_entrega3.sql # Procedimientos, triggers adicionales, vistas y pruebas
│
├── src/
│ ├── connect_and_query.py # Script Python para conexión y consulta básica
│ └── app_entrega3.py # Script Python avanzado (procedimientos + vistas)
│
...
Archivo Word original (Entrega 1):
...
Muestra los resultados de las vistas vw_boletos_detalle y vw_ingresos_por_pelicula.
Archivos añadidos (Entrega 3)
sql/04_entrega3.sql – Procedimientos, triggers adicionales, vistas y bloque de pruebas
src/app_entrega3.py – Aplicación Python que llama procedimientos y muestra vistas
docs/Entrega3_Capturas.docx – Documento Word con evidencias de la entrega 3
Ejecución de la entrega 3
En SQL*Plus (desde la carpeta del proyecto):
sql
Copiar código
@sql/01_schema.sql
@sql/02_sample_data.sql
...
Consultas adicionales para evidencias:
sql
Copiar código
...
docs/Entrega3_Capturas.docx
Incluyen:
Capturas de creación y ejecución de procedimientos almacenados
Capturas de funcionamiento de triggers (bi_log_boleto, bu_cliente_email_lower)
Resultados de las vistas de reportes
Salida de la aplicación app_entrega3.py mostrando invocación de procedimientos y vistas
